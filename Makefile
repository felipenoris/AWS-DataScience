...
help:
	...
	@printf '    bedrock   2 endpoints, ~0.020 USD/h - the AGENT pair only, for the six\n'
	@printf '              AmazonBedrock* blueprints. `bedrock` and `bedrock-runtime` left\n'
	@printf '              this group on 2026-09-12: they are always-on in sandbox/egress,\n'
	@printf '              because Stage 6e s assistant needs them in every session and a\n'
	@printf '              group is per apply\n'
