...
output "s3_gateway_endpoint_id" {
  description = "The INT-05 anchor - the [P] id Stage 5a's bucket policies condition on, read through terraform_remote_state, never pasted (step 3.2). The only endpoint id any policy may name (Lesson 3)."
