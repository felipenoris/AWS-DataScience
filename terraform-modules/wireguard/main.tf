...
resource "aws_instance" "this" {
  ...
  # checkov:skip=CKV_AWS_88:a public address is the point here - this is the tunnel endpoint, the one internet-facing resource in the design, and it is what GuardDuty is enabled for at Stage 15. What bounds it is the security group (one UDP port, step 3.1) and the absence of port 22
