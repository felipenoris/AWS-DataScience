...
| `D1` … `D35` | Numbered key decisions. **One file each** in `docs/plan/decisions/`, with a one-line summary per decision in `docs/plan/decisions/INDEX.md`. Referenced by ID from the stages that consume them. |
