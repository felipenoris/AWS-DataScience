...
| [6g — Access by identity](plan/stages/stage-06g-access-by-identity.md) | D39 executed: the persona deny deleted from the six permission sets, the lake's laptop branch turned into a principal branch on the drop-box, and the instruments, runbooks and documents that described the previous perimeter | not started — written 2026-09-17 |
