...
Stage: [`docs/plan/stages/stage-01c-preventive-policies.md`](../plan/stages/stage-01c-preventive-policies.md).*
...
- **Decision 5 settled by measurement, and the measurement inverted this plan's own premise.** From the
  ...
  — a gap in the instrument, not a fact about EC2, recorded beside the link in `docs/REFERENCES.md`. Scope is
...
- **The battery gained three phases, one per probeable document** — `--phase tags` (6), `--phase rcp` (16),
  ...
  [`docs/plan/runbooks/scp-battery.md`](../plan/runbooks/scp-battery.md).
