...
| Stage 6e — Claude Code on Bedrock | — | *no entries yet*; will carry the model-access form's submission, the first invocation's CloudTrail and proxy readings, and one session's token cost |
