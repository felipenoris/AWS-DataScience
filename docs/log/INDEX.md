...
| Stage 6e — Claude Code on Bedrock | [log-stage-06e-claude-code-bedrock.md](log-stage-06e-claude-code-bedrock.md) | Opened 2026-09-11, header only: no entry yet. Will carry the model-access form's submission, the first invocation's CloudTrail and proxy readings, and one session's token cost. |
