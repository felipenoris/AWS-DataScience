...
3. **One egress, one proxy, two filters.** The whole cloud converges on a single internet egress point
   ...
   leg, and the L7 options priced in `docs/plan/architecture.md` §4.3a now answer a stated requirement.
