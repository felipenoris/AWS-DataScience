...
what makes Stage 1b step 8's alarm the control here rather than a nicety (`docs/ORGANIZATION.md`, "The limit of
...
**Consequence for `docs/ORGANIZATION.md`: it is documented, and since D34 it holds a duty — but it is still
