...
- **8.1 — DONE 2026-09-08, on the recommendations of decisions due 5 and 6 (one key; `DNS` unchanged) —
  the user confirms or reverses both before 8.3.** `vpn.md` §C7: the table of the two profiles (what each
...
6. **Where the split-tunnel profile resolves** (8.1, added 2026-09-08). Recommended: **`DNS = 10.31.0.2` in
