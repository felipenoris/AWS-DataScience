...
### Six findings, each of which changes something written elsewhere
...
| 1.3 | The **account association**, per member account, in the console — then a row in `SMUS_ASSOCIATED` and the second apply of that account's `sagemaker/` slice | **user** + Claude |
