...
The one exception to "nothing is ever created in `Policy Canary`" (`docs/plan/conventions.md`) — the same
...
every outcome in [`docs/log/log-stage-01c-preventive-policies.md`](../../log/log-stage-01c-preventive-policies.md)*
