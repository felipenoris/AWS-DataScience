# Version pin - Stage 2 step 1. The same constraint every slice carries, plus the second provider
# recorded below.
#
...
# check compares; what is added is `awscc`, because two resources in this stage exist in no other
# provider at all (measured against the pinned schemas, 2026-08-21):
#
