...
#
#   ./scripts/gen-backend-hcl.py production networking   (writes the untracked backend.hcl)
#   ./scripts/gen-tfvars.py production networking        (region, env, tag, vpc_cidr, zone_ids)
