...
#
#   ./scripts/gen-backend-hcl.py production foundation   (writes the untracked backend.hcl)
#   ./scripts/gen-tfvars.py production foundation        (region, env, tag, vpc_cidr, zone_ids)
