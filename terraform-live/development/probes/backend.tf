...
#
#   ./scripts/gen-backend-hcl.py development probes   (writes the untracked backend.hcl)
#   ./scripts/gen-tfvars.py development probes        (region, env, tag, zone_ids, account_folder, peer_cidrs)
