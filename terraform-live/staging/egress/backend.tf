...
#
#   ./scripts/gen-backend-hcl.py development egress   (writes the untracked backend.hcl)
#   ./scripts/gen-tfvars.py development egress        (region, env, tag, zone_ids, account_folder)
