...
#
# Cross-account, so the profile rides in the config, and a consumer whose foundation/ has not been
# applied fails by name here, instead of resolving to nothing three resources later. What the read needs beyond S3 is
