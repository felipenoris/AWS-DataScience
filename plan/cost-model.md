...
| Route 53 **private** hosted zones (D15) | ~1.00-1.50 | USD 0.50/zone-month. One per account with a VPC, plus `pages.internal` (Stage 7 step 4). **No public zone before Stage 13** — D15 was revised on 2026-08-09 and the split-horizon design was dropped |
