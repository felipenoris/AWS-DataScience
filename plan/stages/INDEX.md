...
| [Stage 1a — Landing zone, accounts and OUs](stage-01a-landing-zone.md) | Control Tower, ten accounts, five OUs, root secured, budget — the slow, hard-to-undo half. | ready to start — nothing blocking | none outstanding (D1 decided, all ten e-mails registered) |
| [Stage 1b — Identity, policies, detective controls, org-wide enablement](stage-01b-identity-and-controls.md) | Identity Center, permission sets, SCP/RCP, detective controls, org-wide enablement — the fast, reversible half. | not started | Stage 1a complete |
...
| [Stage 7 — GitLab, Runners and ECR](stage-07-gitlab-runners-ecr.md) | GitLab CE on EC2, runners, ECR, CodeArtifact, TLS and split-horizon DNS. | not started | Stages 3 (which now builds the Production VPC), 4; decisions D8, D14, D15. |
...
| [Stage 11 — Data protection and DLP](stage-11-dlp.md) | Macie, CloudTrail data events, GuardDuty, Security Hub — detection on top of the perimeter. | not started | Stages 5, 6, 9; decision D6. |
