...
| Stage 1c — Preventive policies | — | *no entries yet* — **create the file before starting**; it is where every policy ID, the 7.0 preflight output and the four decisions get recorded |
